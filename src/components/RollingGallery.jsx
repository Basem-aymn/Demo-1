...
const RollingGallery = ({ autoplay = false, pauseOnHover = false, images = [] }) => {
  ...
  return (
    <div className="relative h-[600px] w-full overflow-hidden" style={{ backgroundColor: 'rgba(54, 83, 94, 0.1)' }}>
      <div
        className="absolute top-0 left-0 h-full w-[48px] z-10"
        style={{
          background: 'linear-gradient(to left, rgba(54, 83, 94, 0) 0%, rgba(54, 83, 94, 0.1) 100%)'
        }}
      />
      <div
        className="absolute top-0 right-0 h-full w-[48px] z-10"
        style={{
          background: 'linear-gradient(to right, rgba(54, 83, 94, 0) 0%, rgba(54, 83, 94, 0.1) 100%)'
        }}
      />
